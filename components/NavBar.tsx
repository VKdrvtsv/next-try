...
export const NavBar = () => {
  return (
    <div className="max-w-6xl flex flex-row items-center justify-between py-5 w-full mb-3">
      <Link href="/" className="h-10 w-10">
        <Image src="/icons/logo.svg" alt="Logo" width={40} height={40} />
      </Link>

      <div className="flex flex-row font-medium gap-x-20 items-center">
        <NavigationMenu.Root>
          <NavigationMenu.List className="flex flex-row font-medium gap-x-10">
            <NavigationMenu.Item>
            ...
            <NavigationMenu.Item className="w-16">
        ...
        <Toolbar.Root className="flex flex-row gap-2">
